...
import negociodato.negocio.NInsumo;
import negociodato.negocio.NFormula;
...
public class MainPrueba {
    ...
    public static void main(String[] args) {
        ...
        NFormula nFormula = new NFormula();
        ...
        interpreter.setListener(new ITokenEventListener() {
            ...
            public void insumo(TokenEvent event) {
                System.out.println("CU: INSUMO");
                System.out.println(event);
                try {
                    switch (event.getAction()) {
                        case Token.AGREGAR:
                            nInsumo.guardar(event.getParams());
                            System.out.println("OK");
                            break;
                        case Token.MODIFICAR:
                            nInsumo.modificar(event.getParams());
                            System.out.println("OK");
                            break;
                        case Token.ELIMINAR:
                            nInsumo.eliminar(event.getParams());
                            System.out.println("OK");
                            break;
                        case Token.LISTAR:
                            ArrayList<String[]> lista = nInsumo.listar();
                            String s = "";
                            for(int i = 0; i < lista.size(); i++) {
                                s = s + "["+i+"] : ";
                                for(int j = 0; j < lista.get(i).length; j++) {
                            ...
                            break;
                        default:
                            System.out.println("La acción no es válida para el caso de uso");
                            break;
                    }
                } catch (SQLException ex) {
                    System.out.println("Mensaje: " + ex.getSQLState());
            ...
            public void formula(TokenEvent event) {
                throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
            }

            public void produccion(TokenEvent event) {
                throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
            }
